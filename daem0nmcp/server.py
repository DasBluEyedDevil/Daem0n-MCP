...
# mcp is the shared FastMCP instance from mcp_instance.py
...
# ============================================================================
# PROJECT CONTEXT MANAGEMENT - imported from context_manager.py
# All context management symbols (ProjectContext, get_project_context, etc.)
# are imported and re-exported via the import block above.
# ============================================================================
